...
-- Add a default user for existing posts
INSERT INTO "User" ("id", "name", "email", "createdAt", "updatedAt") VALUES ('default-user', 'Default User', 'default@example.com', NOW(), NOW());

-- Set authorId for existing posts
