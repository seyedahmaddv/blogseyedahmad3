...
export default function AboutPage() {
  return (
    <main className="container mx-auto p-4 min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8" dir="rtl">
        ...
        <div className="prose prose-lg max-w-none text-right">
          ...
          <h2 className="text-2xl font-semibold text-blue-600 mb-4">تماس با ما</h2>
          <p className="text-gray-700 mb-4">
            اگر سوال، پیشنهاد یا انتقادی دارید، خوشحال می‌شویم که با ما در میان بگذارید. می‌توانید از طریق فرم تماس موجود در صفحه اصلی با ما ارتباط برقرار کنید.
          </p>
